      ...
      <main className={styles.main}>
		...
		<div className={styles.info}>
			<span className={styles.infoSection}>
				...
				<p className={styles.infoSubtitle}>Our goal is to assist homeless families find housing and have an emergency savings. Using a direct cash transfer model we incentivize families to find housing and save funds.<br></br></p>
